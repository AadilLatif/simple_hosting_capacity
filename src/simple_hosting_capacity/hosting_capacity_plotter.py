...
# from bokeh.palettes import Spectral8, Spectral6
...
class NetworkGraph:
    ...
    def plot(self):
        ...
        color = LinearColorMapper(palette = "Plasma256",
                          low = pv_min, high = pv_max)
    ...
    def _CreatePDEdges(self):
        ...
        while PDElement:
            ...
            element_proterties = self._dssInstance.CktElement.AllPropertyNames()
